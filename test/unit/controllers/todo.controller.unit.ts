...
describe.skip('TodoController', () => {
  ...
  */
  ...
  describe.skip('findTodoById', () => {
    it('returns a todo if it exists', async () => {
      findById.resolves(aTodoWithId);
      expect(await controller.findTodoById(aTodoWithId.id as string)).to.eql(
        aTodoWithId,
      );
  ...
  describe.skip('replaceTodo', () => {
    it('successfully replaces existing items', async () => {
      replaceById.resolves();
      await controller.replaceTodo(aTodoWithId.id as string, aChangedTodo);
  ...
  describe.skip('updateTodo', () => {
    it('successfully updates existing items', async () => {
      updateById.resolves();
      await controller.updateTodo(aTodoWithId.id as string, aChangedTodo);
  ...
  describe.skip('deleteTodo', () => {
    it('successfully deletes existing items', async () => {
      deleteById.resolves();
      await controller.deleteTodo(aTodoWithId.id as string);
